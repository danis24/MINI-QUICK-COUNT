        ...
        <div class="container mx-auto mt-10 px-10">
            ...
            <div class="grid w-full grid-cols-1 gap-4 mt-4 xl:grid-cols-2 2xl:grid-cols-3" style="height: 32rem;">
                <livewire:livewire-column-chart
                        key="{{ $columnChartModelFlag->reactiveKey() }}"
                        :column-chart-model="$columnChartModelFlag"
                    />
                    <livewire:livewire-column-chart
                        key="{{ $columnChartModelLegislative->reactiveKey() }}"
                        :column-chart-model="$columnChartModelLegislative"
                    />
            </div>
            @endif
        </div>
